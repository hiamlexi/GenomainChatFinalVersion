...
const GeneralAgentLLMPreference = lazy(
  () => import("@/pages/GeneralSettings/AgentLLMPreference")
);
            ...
            <PfpProvider>
              <I18nextProvider i18n={i18n}>
                <Routes>
                  ...
                  />
                  <Route
                    path="/settings/agent-llm-preference"
                    element={<AdminRoute Component={GeneralAgentLLMPreference} />}
                  />
                  <Route
