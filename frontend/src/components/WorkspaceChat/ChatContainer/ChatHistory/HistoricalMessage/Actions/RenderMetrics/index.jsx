...
const SHOW_METRICS_KEY = "genomain_show_chat_metrics";
const SHOW_METRICS_EVENT = "genomain_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `genomain_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `genomain_show_chat_metrics` key
 * @returns {void}
 */
